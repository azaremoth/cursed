...
--	MOVEANIMATIONSLEEPTIME = 100
	MOVEANIMATIONSPEED = (GetUnitValue(COB.MAX_SPEED)/100000) -- ord divisor 85196
...
local function Walkscript()
	while true do
		if moving then 
			...
			Turn2( lwing2, x_axis, 80, MOVEANIMATIONSPEED*20 )
			Turn2( lwing31, x_axis, -85, MOVEANIMATIONSPEED*20 )
			Turn2( lwing41, x_axis, -85, MOVEANIMATIONSPEED*20 )
			Turn2( lwing51, x_axis, -85, MOVEANIMATIONSPEED*20 )
			Turn2( rwing1, x_axis, -100, MOVEANIMATIONSPEED*20 )
			Turn2( rwing2, x_axis, 80, MOVEANIMATIONSPEED*20 )
			Turn2( rwing31, x_axis, -85, MOVEANIMATIONSPEED*20 )
			Turn2( rwing41, x_axis, -85, MOVEANIMATIONSPEED*20 )
			Turn2( rwing51, x_axis, -85, MOVEANIMATIONSPEED*20 )			
