...
local function UnitSpawner()
	...
	elseif campaignBattleID == 3 then
		local unitOne = Spring.CreateUnit("euf_pyro", x-30, y, z-30, 0, teamID)
		local unitTwo = Spring.CreateUnit("euf_pyro", x-30, y, z+30, 0, teamID)
		local unitThr = Spring.CreateUnit("euf_pyro", x+30, y, z-30, 0, teamID)
		local unitFou = Spring.CreateUnit("euf_pyro", x+30, y, z+30, 0, teamID)
		local unitFiv = Spring.CreateUnit("euf_pyro", x+40, y, z-40, 0, teamID)
		local unitSix = Spring.CreateUnit("euf_pyro", x+40, y, z+40, 0, teamID)
	elseif campaignBattleID == 4 then
		local unitOne = Spring.CreateUnit("euf_marine", x-30, y, z-30, 0, teamID)
		local unitTwo = Spring.CreateUnit("euf_marine", x-30, y, z+30, 0, teamID)
		local unitThr = Spring.CreateUnit("euf_sniper", x+30, y, z-30, 0, teamID)
		local unitFou = Spring.CreateUnit("euf_bazooka", x+30, y, z+30, 0, teamID)
		local unitFiv = Spring.CreateUnit("euf_bazooka", x+40, y, z-40, 0, teamID)
