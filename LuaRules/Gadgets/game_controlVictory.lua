...
if scoreMode == nil then scoreModeAsString = "Disabled" end
...
if (scoreModeAsString ~= "Disabled") then
	...
	----------------------------------
			...
			if scoreModeAsString == "Domination" then
				...
				-- if usemapconfig == "enabled" then
					...
					if numberOfControlPoints == 1 then
					--Since no config file is found, we create 1 point
						points[1] = {
							x=MapCenterX,
							y=0,
							z=MapCenterZ,
						...
						local crystals = Spring.CreateUnit("crystals", MapCenterX,0,MapCenterZ, 0, gaia)
						local crystalcircle1 = Spring.CreateFeature("koth_crystal", MapCenterX+captureRadius,0,MapCenterZ, math.random(-32767, 32767), gaia)
						local crystalcircle2 = Spring.CreateFeature("koth_crystal", MapCenterX-captureRadius,0,MapCenterZ, math.random(-32767, 32767), gaia)
						local crystalcircle3 = Spring.CreateFeature("koth_crystal", MapCenterX,0,MapCenterZ+captureRadius, math.random(-32767, 32767), gaia)
						local crystalcircle4 = Spring.CreateFeature("koth_crystal", MapCenterX,0,MapCenterZ-captureRadius, math.random(-32767, 32767), gaia)
						local crystalcircle5 = Spring.CreateFeature("koth_crystal2", MapCenterX+(captureRadius*0.71),0,MapCenterZ+(captureRadius*0.71), math.random(-32767, 32767), gaia)
						local crystalcircle6 = Spring.CreateFeature("koth_crystal2", MapCenterX+(captureRadius*0.71),0,MapCenterZ-(captureRadius*0.71), math.random(-32767, 32767), gaia)			
						local crystalcircle7 = Spring.CreateFeature("koth_crystal2", MapCenterX-(captureRadius*0.71),0,MapCenterZ+(captureRadius*0.71), math.random(-32767, 32767), gaia)			
						local crystalcircle8 = Spring.CreateFeature("koth_crystal2", MapCenterX-(captureRadius*0.71),0,MapCenterZ-(captureRadius*0.71), math.random(-32767, 32767), gaia)
						numberofsmallcrystals = math.floor(captureRadius/15)
						for i = 1, numberofsmallcrystals, 1 do
							if (math.random(0, 1) > 0) then
								Spring.CreateFeature("koth_crystal_small", MapCenterX+math.sin(i)*captureRadius+math.random(-50,50),0,MapCenterZ+math.cos(i)*captureRadius+math.random(-50,50), math.random(-32767, 32767), gaia)
							else
								Spring.CreateFeature("koth_crystal_small2", MapCenterX+math.sin(i)*captureRadius+math.random(-50,50),0,MapCenterZ+math.cos(i)*captureRadius+math.random(-50,50), math.random(-32767, 32767), gaia)
							end
						end		
					end
