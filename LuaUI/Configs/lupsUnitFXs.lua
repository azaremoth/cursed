effectUnitDefs = { 
  ...
  euf_sarge_lvl6 = {    {class='GroundFlash', options=HeroAura},    },
  euf_sarge_lvl7 = {    {class='GroundFlash', options=HeroAura},    },
  euf_sarge_lvl8 = {    {class='GroundFlash', options=HeroAura},    },
  euf_sarge_lvl9 = {    {class='GroundFlash', options=HeroAura},    },
  euf_sarge_lvl10 = {    {class='GroundFlash', options=HeroAura},    },  
  ...
  tc_shade_lvl6 = {    {class='GroundFlash', options=HeroAura},      {class='AirJet', options={color={0.8, 1.0, 0.0}, width=1, length=28, piece="katana_r", emitVector = {0, 0, 1}, onActive=false, noIconDraw = true}}, {class='AirJet', options={color={0.8, 1.0, 0.0}, width=1, length=28, piece="katana_l", emitVector = {0, 0, 1}, onActive=false, noIconDraw = true}}, },
  tc_shade_lvl7 = {    {class='GroundFlash', options=HeroAura},      {class='AirJet', options={color={0.8, 1.0, 0.0}, width=1, length=28, piece="katana_r", emitVector = {0, 0, 1}, onActive=false, noIconDraw = true}}, {class='AirJet', options={color={0.8, 1.0, 0.0}, width=1, length=28, piece="katana_l", emitVector = {0, 0, 1}, onActive=false, noIconDraw = true}}, },
  tc_shade_lvl8 = {    {class='GroundFlash', options=HeroAura},      {class='AirJet', options={color={0.8, 1.0, 0.0}, width=1, length=28, piece="katana_r", emitVector = {0, 0, 1}, onActive=false, noIconDraw = true}}, {class='AirJet', options={color={0.8, 1.0, 0.0}, width=1, length=28, piece="katana_l", emitVector = {0, 0, 1}, onActive=false, noIconDraw = true}}, },
  tc_shade_lvl9 = {    {class='GroundFlash', options=HeroAura},      {class='AirJet', options={color={0.8, 1.0, 0.0}, width=1, length=28, piece="katana_r", emitVector = {0, 0, 1}, onActive=false, noIconDraw = true}}, {class='AirJet', options={color={0.8, 1.0, 0.0}, width=1, length=28, piece="katana_l", emitVector = {0, 0, 1}, onActive=false, noIconDraw = true}}, },
  tc_shade_lvl10 = {    {class='GroundFlash', options=HeroAura},      {class='AirJet', options={color={0.8, 1.0, 0.0}, width=1, length=28, piece="katana_r", emitVector = {0, 0, 1}, onActive=false, noIconDraw = true}}, {class='AirJet', options={color={0.8, 1.0, 0.0}, width=1, length=28, piece="katana_l", emitVector = {0, 0, 1}, onActive=false, noIconDraw = true}}, },
