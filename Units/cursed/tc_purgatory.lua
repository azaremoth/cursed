...
local unitDef = {
  ...
  customParams          = {
	factionname		   = "cursed",
    helptext = "The is the cursed long range artillery. It needs to be deployed before it can shoot."			
  },
  defaultmissiontype = "Standby",
  description        = "Deployable Artillerie",
  --  energyMake         = "-3.5",
