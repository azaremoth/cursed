...
local panelTexture    = LUAUI_DIRNAME.."Images/panel.png"
...
local function UpdateAnger()
	...
	local angerString = "Scourge Anger : ".. GetColor( math.min(angerPercent, 100) )..math.floor(angerPercent).."% \008"
...
local function UpdateRules()
	...
	label_chickens:SetCaption("Undead alive/killed : \255\0\255\0"..chickenCount.."\008/\255\255\0\0"..chickenKills)
...
--[[?	if (gameInfo["humanAggro"] >=4) then
	...
	label_chickens.tooltip = "Undead spawn every ".. GetDifficultyValue('chickenSpawnRate') .." seconds\n"..MakeChickenBreakdown()
