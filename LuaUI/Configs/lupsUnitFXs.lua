effectUnitDefs = { 
  ...
  tc_shade_lvl7 = {    {class='GroundFlash', options=HeroAura},     },
  tc_shade_lvl8 = {    {class='GroundFlash', options=HeroAura},     },
  tc_shade_lvl9 = {    {class='GroundFlash', options=HeroAura},     },
  tc_shade_lvl10 = {    {class='GroundFlash', options=HeroAura},    },
