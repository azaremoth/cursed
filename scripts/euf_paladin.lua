	...
	while true do
		if moving then
			...
			if not attacking and not isparrying then
				Turn2( ruparm, x_axis, 30, MOVEANIMATIONSPEED*1.7 )
			end
...
--			SetMoveAnimationSpeed()
			if not attacking and not isparrying then
				Turn2( luparm, x_axis, -30, MOVEANIMATIONSPEED*1.7 )
...
--			SetMoveAnimationSpeed()
		...
		if not moving then
			...
			if not attacking and not isparrying then 
				Turn2( lloarm, x_axis, 30, MOVEANIMATIONSPEED*2 )
				Turn2( luparm, x_axis, 0, MOVEANIMATIONSPEED*3 )
				Turn2( ruparm, x_axis, 0, MOVEANIMATIONSPEED*1.7 )
				Turn2( rhand, y_axis, rturn*2-70, MOVEANIMATIONSPEED*2 )					
