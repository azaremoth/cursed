effectUnitDefs = { 
  ...
  tc_shade      = {    {class='GroundFlash', options=HeroAura}, 	},
  tc_shade_lvl1 = {    {class='GroundFlash', options=HeroAura},     {class='StaticParticles', options=MergeTable(Greenglow_small_stable,{piece="emit_twohanded"})},		{class='AirJet', options={color={0.6,1.0,0.15}, width=7, length=-70, piece="emit_twohanded", onActive=false, noIconDraw = true}},	},
  tc_shade_lvl2 = {    {class='GroundFlash', options=HeroAura},     {class='StaticParticles', options=MergeTable(Greenglow_small_stable,{piece="emit_twohanded"})},		{class='AirJet', options={color={0.6,1.0,0.15}, width=5, length=-70, piece="emit_twohanded", onActive=false, noIconDraw = true}},	},
  tc_shade_lvl3 = {    {class='GroundFlash', options=HeroAura},     {class='StaticParticles', options=MergeTable(Greenglow_small_stable,{piece="emit_twohanded"})},		{class='AirJet', options={color={0.6,1.0,0.15}, width=7, length=-70, piece="emit_twohanded", onActive=false, noIconDraw = true}},	},
  tc_shade_lvl4 = {    {class='GroundFlash', options=HeroAura},     {class='StaticParticles', options=MergeTable(Greenglow_small_stable,{piece="emit_twohanded"})},		{class='AirJet', options={color={0.6,1.0,0.15}, width=7, length=-70, piece="emit_twohanded", onActive=false, noIconDraw = true}},	},
  tc_shade_lvl5 = {    {class='GroundFlash', options=HeroAura},     },
  tc_shade_lvl6 = {    {class='GroundFlash', options=HeroAura},     },
  tc_shade_lvl7 = {    {class='GroundFlash', options=HeroAura},     {class='StaticParticles', options=MergeTable(Greenglow_tiny_stable,{piece="emit_lkatana"})}, {class='AirJet', options={color={0.6,1.0,0.15}, width=3, length=-50, piece="emit_lkatana", onActive=false, noIconDraw = true}},	},
