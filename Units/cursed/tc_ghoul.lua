...
--	normalmaps = "yes",	
	...
	unitjumpjink = "300",
	jumpclass = [[ghoul]],
--    description_de = [[Untoter Nahkaempfer]],
--    helptext_de    = [[Schnelle Einheit, die springen kann und somit ein gutes Gegenmittel gegen Fernkämpfer darstellt. Kann sich eingraben.]],	
