...
--				Turn2( torso, y_axis, 0, MOVEANIMATIONSPEED*12.34 )
			...
			Turn2( tail1, y_axis, 15, MOVEANIMATIONSPEED*30 )
			Turn2( tail3, y_axis, 35, MOVEANIMATIONSPEED*30 )
			Turn2( tail5, y_axis, 35, MOVEANIMATIONSPEED*50 )
			Turn2( tail7, y_axis, 45, MOVEANIMATIONSPEED*50 )
			Turn2( tail9, y_axis, 55, MOVEANIMATIONSPEED*50 )
		end
		Sleep( 10)
	end
end
