...
local function UnitSpawner()
	...
	elseif campaignBattleID == 3 then
		local unitOne = Spring.CreateUnit("euf_pyro", x-50, y, z-50, 0, teamID)
		local unitTwo = Spring.CreateUnit("euf_pyro", x-50, y, z+50, 0, teamID)
		local unitThr = Spring.CreateUnit("euf_pyro", x+50, y, z-50, 0, teamID)
		local unitFou = Spring.CreateUnit("euf_pyro", x+50, y, z+50, 0, teamID)
		local unitFiv = Spring.CreateUnit("euf_pyro", x+55, y, z-55, 0, teamID)
	...
	elseif campaignBattleID == 4 then
		...
		local unitSix = Spring.CreateUnit("euf_marine", x+55, y, z+55, 0, teamID)		
	end
	Sleep(2000)
end
